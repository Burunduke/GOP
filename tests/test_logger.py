...
class TestLogger(unittest.TestCase):
    ...
    def test_setup_logger_console_only(self):
        ...
        logger = setup_logger(
            self.logger_name, level=logging.INFO, console=True, log_file=None
        )
    ...
    def test_setup_logger_file_only(self):
        ...
        logger = setup_logger(
            self.logger_name, level=logging.DEBUG, console=False, log_file=log_file
        )
    ...
    def test_setup_logger_console_and_file(self):
        ...
        logger = setup_logger(
            self.logger_name, level=logging.WARNING, console=True, log_file=log_file
        )
    ...
    def test_logger_level_filtering(self):
        ...
        logger = setup_logger(
            self.logger_name, level=logging.WARNING, console=False, log_file=log_file
        )
    ...
    def test_logger_exception_logging(self):
        ...
        logger = setup_logger(
            self.logger_name, level=logging.ERROR, console=False, log_file=log_file
        )
