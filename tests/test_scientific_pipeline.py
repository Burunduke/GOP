...
class TestScientificPipeline(unittest.TestCase):
    ...
    def test_classification_methods(self):
        ...
        plant_condition = {"statistics": {"overall": {"mean": 0.75, "std": 0.1}}}
    ...
    def test_error_handling(self):
        ...
        with self.assertRaises(FileNotFoundError):
            self.pipeline.process(
                input_path="nonexistent_file.bil", output_dir=self.test_dir
            )
    ...
    def test_data_improvement_metrics(self):
        ...
        improved_data = original_data * 1.2 + np.random.normal(
            0, 0.05, original_data.shape
        )
