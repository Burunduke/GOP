...
class TestHyperspectralCorrections(unittest.TestCase):
    ...
    def test_radiometric_correction_valid_data(self) -> None:
    ...
    def test_radiometric_correction_custom_method(self) -> None:
    ...
    def test_radiometric_correction_invalid_method(self) -> None:
    ...
    def test_correction_pipeline(self) -> None:
    ...
    def test_estimate_atmospheric_parameters(self) -> None:
    ...
    def test_evaluate_correction_quality(self) -> None:
