...
class TestIndexCalculator(unittest.TestCase):
    ...
    def test_calculate_single_index(self):
        ...
        result = self.calculator.calculate(
            self.spectral_data, ["GNDVI"], self.segmentation_mask
        )
    ...
    def test_calculate_multiple_indices(self):
        ...
        result = self.calculator.calculate(
            self.spectral_data, indices, self.segmentation_mask
        )
    ...
    def test_calculate_all_indices(self):
        ...
        result = self.calculator.calculate(
            self.spectral_data, None, self.segmentation_mask  # Все индексы
        )
    ...
    def test_assess_plant_condition(self):
        ...
        indices_result = self.calculator.calculate(
            self.spectral_data, ["GNDVI", "NDWI", "MCARI"], self.segmentation_mask
        )

        # Оценка состояния
        condition_result = self.calculator.assess_plant_condition(
            indices_result, self.segmentation_mask
        )
    ...
    def test_invalid_index(self):
        ...
        with self.assertRaises(ValueError):
            self.calculator.calculate(
                self.spectral_data, ["INVALID_INDEX"], self.segmentation_mask
            )
    ...
    def test_empty_segmentation_mask(self):
        ...
        result = self.calculator.calculate(self.spectral_data, ["GNDVI"], empty_mask)
    ...
    def test_save_and_load_results(self):
        ...
        # Расчет индексов
        result = self.calculator.calculate(
            self.spectral_data, ["GNDVI", "NDWI"], self.segmentation_mask
        )
...
class TestIndexDefinitions(unittest.TestCase):
    ...
    def test_calculate_index_with_invalid_data_type(self):
        ...
        result = self.calculator.calculate(
            invalid_data.astype(np.uint8), ["GNDVI"], self.segmentation_mask
        )
    ...
    def test_assess_plant_condition_with_empty_indices(self):
        ...
        with self.assertRaises(ValueError):
            self.calculator.assess_plant_condition(
                empty_indices, self.segmentation_mask
            )
    ...
    def test_calculate_index_edge_cases(self):
        ...
        result = self.calculator.calculate(zero_data, ["GNDVI"], self.segmentation_mask)
        ...
        result = self.calculator.calculate(
            large_data, ["GNDVI"], self.segmentation_mask
        )
    ...
    def test_assess_plant_condition_different_masks(self):
        ...
        indices_result = self.calculator.calculate(
            self.spectral_data, ["GNDVI", "NDWI"], single_class_mask
        )
